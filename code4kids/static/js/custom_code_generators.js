...
Blockly.JavaScript['statement_condition_if'] = function(block) {
  ...
  var value_condition_false = Blockly.JavaScript.valueToCode(block, 'condition_false', Blockly.JavaScript.ORDER_ATOMIC);
  var code = '{"name":"IfStart","condition":' + value_condition + '},\n';
  code += value_condition_true;
  code += '{"name":"Else"},\n';
  code += value_condition_false + '{"name":"IfEnd"},\n' + value_next_statement;
